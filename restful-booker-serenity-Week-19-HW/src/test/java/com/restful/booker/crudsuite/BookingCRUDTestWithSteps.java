...
public class BookingCRUDTestWithSteps extends TestBase {
    ...
    public static String firstname = "Hardik" + TestUtils.getRandomValue();
    public static String lastname = "Savalia" + TestUtils.getRandomValue();
    public static Integer totalprice = 525;
